...
def usage():
    ...
    print("")
    print("\033[1;31m               +------------------------------+")
    print("               +\033[1;32m     GENERADOR DE BIN PD      \033[1;31m+")
    print("               +------------------------------+")
    print("")
    print("+---------------+")
    ...
    print("\033[1;31m")
    print("+---------------+")
    print("+\033[;32m Editado por PD\033[1;31m +")
    print("+---------------+\033[0m")
    print("")
    print("\033[1;33m Nickname: Pollito Dorado\033[0m")
    print("\033[1;33m Youtube: Pollito Dorado\033[0m")
    print("\033[1;33m Telegram: t.me/Jose_Vip \033[0m")
    print("\033[1;33m Facebook: Jose pariona ludeña")
    print("")
